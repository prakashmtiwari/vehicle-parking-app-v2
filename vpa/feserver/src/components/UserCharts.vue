...
async function loadReservations() {
  ...
  try {
    ...
    console.log("Loaded user reservations:", reservations.value)
...
function renderCharts() {
  ...
  console.log("Chart data:", { labels, counts, amounts })
  ...
  console.log("Canvas elements:", { pieCtx, barCtx })
        ...
        tooltip: {
          ...
          callbacks: {
            label: (context) => {
              ...
              return `Amount Paid: ₹${value.toFixed(2)}`
            }
          }
        }
      },
  ...
  <div class="charts-component">
    ...
    <div v-else-if="reservations.length === 0" class="empty-state-card">
      <div class="empty-content">
        ...
        <p class="empty-subtext">Your analytics will appear here once you make reservations</p>
      </div>
    </div>
    ...
    <div v-else class="charts-grid">
      ...
      <div class="chart-card">
        <div class="chart-header">
          ...
          <div>
            ...
            <p class="chart-subtitle">Your reservations across parking lots</p>
          </div>
        </div>
      ...
      <div class="chart-card">
        <div class="chart-header">
          <div class="chart-icon">💰</div>
          <div>
            <h3 class="chart-title">Spending Analysis</h3>
            <p class="chart-subtitle">Total amount spent per parking lot</p>
          </div>
        </div>
        <div class="chart-body">
